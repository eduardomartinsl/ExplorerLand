...
public class MassGrassCreator : ScriptableWizard  {
	...
	static void createWizard() {
		...
		ScriptableWizard.DisplayWizard("Select terrain to put grass on", typeof (MassGrassCreator), "Place Grass on Terrain");
